//: C07:Ring.cpp
// ѕостроение кольцевой структуры данных на базе STL
#include <iostream>
#include <iterator>
#include <list>
#include <string>
...
template<class T> class Ring {
  list<T> lst;
public:
  // ќбъ€вление класса необходимо дл€ того, чтобы
  // следующее объ€вление 'friend' видело итератор 'iterator'
  // вместо std::iterator:
  class iterator;
...
int main() {
  ...
  it.insert("six");
  it = rs.begin();
  // ƒвукратный перебор элементов кольца:
